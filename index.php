...
<body>
  <div class="header">
    <div class="row">
      <div class="col-lg-6">'
        <span class="logo"> <img src="image/logo.jpeg" class="img-fluid" width="130" alt="PROCTOROUS" type="image/x-icon" />   proctorous</span>
      </div>
...
{ echo'<p style="color:red;font-size:15px;">'.@$_GET['q7'];}?>
  ...
  <div class="row footer">
    ...
    <div class="col-md-3 box">
      <a href="feedback.php" target="_blank">Contact Us</a>
    </div>
  </div>
